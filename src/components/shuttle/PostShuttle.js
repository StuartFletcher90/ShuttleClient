...
class PostShuttle extends Component {
  state = {
    open: false,
    body: "",
    errors: {}
  ...
  handleSubmit = event => {
    ...
    this.props.postShuttle({ body: this.state.body });
  };
  render() {
...
PostShuttle.propTypes = {
  postShuttle: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { postShuttle, clearErrors })(
  withStyles(styles)(PostShuttle)
);
